...
export default function EditSubject({subject, editModal, modalHandler}) {
    ...
    const updateSubjectHandler = (e)=>{
        e.preventDefault()

        const filteredSubjects = subjects.filter((subj)=> subj.id !== subject.id)
        const updatedSubject = {
            id: Math.random(),
            name,
            description
        }
        filteredSubjects.push(updatedSubject)
