...
export default function SubjectMenu({subject}) {
  ...
  const deleteSubjectHandler = (e)=>{
    e.preventDefault()
    const newSubjects = subjects.filter((subj)=> subj.id !== subject.id)
  ...
  return (
      ...
      {editModal? <EditSubject subject={subject} editModal = {editModal} modalHandler = {modalHandler}/>: null}
