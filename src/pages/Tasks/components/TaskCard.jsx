...
export default function TaskCard({task,taskStatusHandler}) {
    const {id, title, status, description, date, label, flagged} = task
  return(
          ...
          <section className='flex flex-col mb-5'>
                <div className='flex justify-between'>
                    <span className='outline-none mb-1 flex items-center gap-1'>
                        ...
                        onChange = {(event)=>taskStatusHandler(task, event)}
                        />
